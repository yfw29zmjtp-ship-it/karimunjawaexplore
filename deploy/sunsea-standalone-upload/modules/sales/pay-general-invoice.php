...
try {
    ...
    try {
        ...
        error_log("pay-general-invoice: Error getting cash_account_id: " . $e->getMessage());
    }
    ...
    if ($cashAccountId) {
        try {
            ...
            error_log("pay-general-invoice: Updated cash_account {$cashAccountId} +{$invoice['total_amount']}");
        } catch (Exception $e) {
            error_log("pay-general-invoice: Error updating balance: " . $e->getMessage());
        }
    }
