...
<style>
    * { margin:0; padding:0; box-sizing:border-box; }
    :root {
        --ocean:#0369A1; --danger:#DC2626; --muted:#64748B; --text:#1E293B; --border:#E2E8F0;
    }
    body {
    ...
    .ol-card {
        width:100%; max-width:360px; background:rgba(255,255,255,.92); backdrop-filter:blur(14px);
        border-radius:22px; padding:30px 26px; box-shadow:0 20px 50px rgba(3,105,161,.25);
        text-align:center;
    }
    .ol-logo {
        width:64px; height:64px; border-radius:16px; background:#fff; margin:0 auto 14px;
        display:flex; align-items:center; justify-content:center; box-shadow:0 4px 14px rgba(0,0,0,.1);
        font-size:28px; overflow:hidden;
    }
    .ol-logo img { width:100%; height:100%; object-fit:contain; }
    .ol-eyebrow { font-size:11px; font-weight:700; letter-spacing:.08em; text-transform:uppercase; color:var(--ocean); }
    .ol-title { font-size:19px; font-weight:800; color:var(--text); margin:4px 0 22px; }
    .ol-field { text-align:left; margin-bottom:14px; }
    .ol-label { font-size:11.5px; font-weight:600; color:var(--muted); margin-bottom:5px; display:block; }
    .ol-input {
        width:100%; padding:12px 14px; border-radius:12px; border:1.5px solid var(--border);
        font-size:14px; color:var(--text); background:#fff;
    }
    .ol-input:focus { outline:none; border-color:var(--ocean); }
    .ol-error {
        background:#FEF2F2; color:var(--danger); font-size:12px; font-weight:600;
        padding:9px 12px; border-radius:10px; margin-bottom:14px; text-align:left;
    }
    .ol-submit {
        width:100%; padding:13px; border:none; border-radius:12px; margin-top:6px;
        background:linear-gradient(135deg,#0369A1,#0EA5E9); color:#fff; font-size:14px; font-weight:700;
    }
    .ol-foot { margin-top:18px; font-size:11px; color:var(--muted); }
</style>
</head>
<body>
    <div class="ol-card">
