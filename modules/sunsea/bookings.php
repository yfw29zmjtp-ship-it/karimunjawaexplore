...
$list = safeFetchAll(
    ...
    "SELECT b.*, c.name as customer_name, c.phone as customer_phone, p.name as package_name,
        ...
        (SELECT component_name FROM booking_order_items WHERE booking_id=b.id AND (component_code IN ('penginapan','accommodation') OR item_type IN ('penginapan','accommodation')) ORDER BY sort_order LIMIT 1) AS accommodation_item
