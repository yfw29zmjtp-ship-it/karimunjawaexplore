        ...
        <div class="we-chat-widget" id="weChatWidget">
            ...
            <button type="button" class="we-chat-fab" id="weChatFab" onclick="weChatToggle()" aria-label="Chat WhatsApp">
                <svg class="we-chat-fab-icon" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
                    <defs>
                        <linearGradient id="weChatFabGrad" x1="0%" y1="0%" x2="100%" y2="100%">
                            <stop offset="0%" stop-color="var(--we-ocean)" />
                            <stop offset="100%" stop-color="var(--we-ocean-dark)" />
                        </linearGradient>
                    </defs>
                    <path fill="url(#weChatFabGrad)" d="M12.031 6.172c-5.184 0-9.395 4.211-9.397 9.399-.001 1.66.433 3.279 1.257 4.705l-1.339 4.887 5.003-1.312a9.386 9.386 0 0 0 4.474 1.14h.004c5.183 0 9.394-4.211 9.396-9.399.001-2.511-.973-4.872-2.746-6.647a9.35 9.35 0 0 0-6.652-2.773zm5.529 13.428h-.004a7.9 7.9 0 0 1-4.026-1.104l-.288-.172-2.995.785.799-2.921-.187-.299a7.9 7.9 0 0 1-1.213-4.219c.002-4.354 3.549-7.9 7.913-7.9 2.112 0 4.1.826 5.593 2.319a7.87 7.87 0 0 1 2.311 5.601c-.002 4.354-3.549 7.9-7.903 7.9zm4.329-5.925c-.237-.119-1.406-.694-1.623-.774-.218-.079-.377-.119-.535.119-.159.238-.614.774-.753.932-.139.158-.278.178-.515.06-.237-.119-1.001-.369-1.906-1.176-.705-.629-1.181-1.406-1.319-1.644-.139-.238-.015-.366.104-.484.107-.107.238-.278.357-.417.119-.139.158-.238.238-.396.079-.158.04-.297-.02-.416-.06-.119-.535-1.29-.733-1.766-.193-.463-.389-.4-.535-.408-.139-.007-.297-.008-.456-.008a.876.876 0 0 0-.634.297c-.218.238-.833.814-.833 1.984s.853 2.301.972 2.459c.119.158 1.678 2.562 4.066 3.593.568.245 1.011.391 1.357.5.57.181 1.089.156 1.499.095.457-.068 1.406-.575 1.605-1.13.198-.555.198-1.031.139-1.13-.059-.099-.218-.158-.456-.277z" />
                </svg>
            </button>
        </div>
